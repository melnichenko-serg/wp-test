    ...
    <div class="side_blog_bg">
        ...
        <div class="sidebar_wrap">
            ...
            <div class="category-detail">
                <ul>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Company news
                            <span> 25 </span></a></li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i>Updates <span> 15 </span> </a>
                    </li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Fresh releases <span> 35 </span>
                        </a></li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Actions & offers
                            <span> 10 </span> </a></li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Travel <span> 18 </span> </a>
                    </li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Music <span> 16 </span> </a>
                    </li>
                    <li><a href="#"> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Food & Drink <span> 25 </span>
                        </a></li>
                </ul>
            </div>
        </div>
